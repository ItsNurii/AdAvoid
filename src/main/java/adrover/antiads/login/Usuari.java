...
/**
 * Maps to the API Usuari JSON. Unknown JSON properties will be ignored. Note:
 * API byte[] fields (picture) are expected as base64 strings and Jackson will
 * decode into byte[]. If you prefer typed date handling, register
 * JavaTimeModule on your ObjectMapper and change date fields to
